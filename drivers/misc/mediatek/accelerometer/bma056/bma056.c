...
/*******************yanghaichao add start******************************
static int __init bma255_init(void)
{
	
	struct acc_hw *hw = get_cust_acc_hw();
#ifdef USE_BMC55_COMBA_CHIP 
	if(!BMC55_INIT)
	{
#ifdef BMAA056_I2C_GPIO_MODE
		cust_i2c_scl_set(1);
		cust_i2c_sda_set(1);
#endif
		//hwPowerOn(MT65XX_POWER_LDO_VRF28_2, VOL_1800, "bma_056");
		//hwPowerOn(MT65XX_POWER_LDO_VIO28, VOL_2800, "BMA_255");
		//msleep(100);
		BMC55_INIT = 1;
	}
#endif
...
{
	GSE_FUN();
	//hwPowerDown(MT65XX_POWER_LDO_VRF28_2, "bma_056");
	//hwPowerDown(MT65XX_POWER_LDO_VIO28, "BMA_255");
