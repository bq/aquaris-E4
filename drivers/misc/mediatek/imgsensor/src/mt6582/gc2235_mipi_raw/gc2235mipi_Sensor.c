...
static void GC2235_Sensor_Init(void)
{
	...
	GC2235_write_cmos_sensor(0xf8, 0x84); //Pll mode 2 //0x84->0x8c
	#else //20fps
	...
	#ifdef GC2235_MIPI_30FPS
	GC2235_write_cmos_sensor(0x03, 0x05);  //30fps setting
	...
	GC2235_write_cmos_sensor(0x06, 0x1d);//hb
	GC2235_write_cmos_sensor(0x07, 0x00);
	GC2235_write_cmos_sensor(0x08, 0x9b);//vb
	...
	GC2235_write_cmos_sensor(0x10, 0x50);//50->60
	...
	GC2235_write_cmos_sensor(0x20, 0x03);//03->0x83 08/14
	GC2235_write_cmos_sensor(0x21, 0x6f); //0x6f->0x7f
	GC2235_write_cmos_sensor(0x22, 0x80); 
	GC2235_write_cmos_sensor(0x23, 0xc1);//c1->42 08/14
	...
	GC2235_write_cmos_sensor(0x40, 0x72); //smooth speed  //0x72->0x7a->0x72->>0x42
	GC2235_write_cmos_sensor(0x41, 0x04);
		GC2235_write_cmos_sensor(0x43, 0x18);
...
UINT32 GC2235GetSensorID(UINT32 *sensorID)
{
    ...
    *sensorID =((GC2235_read_cmos_sensor(0xf0) << 8) | GC2235_read_cmos_sensor(0xf1)); 
	...
	s_DEVINFO_ccm->device_module = "AE712-F";//can change if got module id
	s_DEVINFO_ccm->device_vendor = "BOYI";
	s_DEVINFO_ccm->device_ic = "GC2235_MIPI";
                                                                ...
                                                                UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_PERIOD:
				*pFeatureReturnPara16++= GC2235_PV_PERIOD_PIXEL_NUMS;
				*pFeatureReturnPara16= GC2235_PV_PERIOD_LINE_NUMS;
				*pFeatureParaLen=4;
				break;
