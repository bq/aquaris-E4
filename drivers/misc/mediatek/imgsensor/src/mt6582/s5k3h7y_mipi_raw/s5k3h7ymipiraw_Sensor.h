...
typedef struct
{
	...
	#define S5K3H7Y_PV_PERIOD_PIXEL_NUMS					(0x1B00) 	// 0x0E68=3688	
#else	
	#define S5K3H7Y_PV_PERIOD_PIXEL_NUMS					(0x0E68)	// 0x0E68=3688
#endif	
	#define S5K3H7Y_PV_PERIOD_LINE_NUMS 					(0x04F0)  	//(0x0940=2368
		//Video
	#define S5K3H7Y_VIDEO_PERIOD_PIXEL_NUMS					(S5K3H7Y_PV_PERIOD_PIXEL_NUMS) 	// 0x0E68=3688
	#define S5K3H7Y_VIDEO_PERIOD_LINE_NUMS					(0x04F0)  	//(0x0928=2344
		//Capture	
	#define S5K3H7Y_FULL_PERIOD_PIXEL_NUMS					(0x1CD0)	//0x0E68=3688
	#define S5K3H7Y_FULL_PERIOD_LINE_NUMS					(0x09B5)		//0x0B72=2930	//0x09E2=2530
		//ZSD
	...
	#define S5K3H7Y_IMAGE_SENSOR_VIDEO_WIDTH_SETTING 		(1600)
	#define S5K3H7Y_IMAGE_SENSOR_VIDEO_HEIGHT_SETTING		(1200)
	#define S5K3H7Y_IMAGE_SENSOR_VIDEO_WIDTH 				(S5K3H7Y_IMAGE_SENSOR_VIDEO_WIDTH_SETTING-32) //(2176-64)
	#define S5K3H7Y_IMAGE_SENSOR_VIDEO_HEIGHT 				(S5K3H7Y_IMAGE_SENSOR_VIDEO_HEIGHT_SETTING-18) //(1224-36)	
	...
	//#define S5K3H7Y_MIN_LINE_LENGTH						(0x1CD0)	//2724
