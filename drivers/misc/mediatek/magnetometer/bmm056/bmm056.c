...
#define MSE_ERR(fmt, args...)		printk( MSE_TAG"%s %d : "fmt, __FUNCTION__, __LINE__, ##args)
...
{
	printk("yhc debug bmm050_i2c_probe satart\n");
	...
	MSE_LOG("%s: OK\n", __func__);
	printk("yhc debug bmm050_i2c_probe over\n");
...
static int bmm050_probe(struct platform_device *pdev) 
{
	...
	printk("yhc debug bmm050_probe satart\n");
	...
	printk("yhc debug bmm050_probe over\n");
...
{
	printk("yhc debug for bmm050_init start\n ");
	struct mag_hw *hw = get_cust_mag_hw();
	
	//	hwPowerOn(MT65XX_POWER_LDO_VRF28_2, VOL_1800, "bmm_056");  //yhc modify 12.29 for power issue.
	
	//	hwPowerOn(MT65XX_POWER_LDO_VIO28, VOL_2800, "bmm_056");
	...
	if(platform_driver_register(&bmm050_sensor_driver))
	{
		...
		printk("yhc debug for bmm050_init over\n ");
...
{	
	...
	//hwPowerDown(MT65XX_POWER_LDO_VRF28_2, "bmm_056");
	//hwPowerDown(MT65XX_POWER_LDO_VIO28, "bmm_056");
