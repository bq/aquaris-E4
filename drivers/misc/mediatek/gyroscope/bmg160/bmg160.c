...
//#if defined(MT6573) || defined(MT6575) || defined(MT6577) || defined(MT6582) || defined(MT6592)
...
{
	printk("yhc debug bmg_i2c_probe  start\n");
...
*/
printk("yhc debug bmg_i2c_probe  over\n");
	GYRO_LOG("%s: OK\n", __func__);
	return 0;
...
{
	printk("yhc debug bmg_probe  start\n");
	...
	printk("yhc debug bmg_probe  over\n");
...
{
	GYRO_FUN();
	//hwPowerDown(MT65XX_POWER_LDO_VRF28_2, "bmg_160");
	//hwPowerDown(MT65XX_POWER_LDO_VIO28, "bmg_160");
